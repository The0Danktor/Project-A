...
# menu display function [displays the menu screen]
def displayScreen(images):
    if (width*0.665 < mouseX < width*0.910) and (height*0.163 < mouseY < height*0.344):
        refresh(1, images)
        image(images['start_img'], width*0.655, height*0.153, width*0.265, height*0.201)
        image(images['settings_img'], width*0.650, height*0.401, width*0.290, height*0.198)
        image(images['exit_img'], width*0.684, height*0.645, width*0.208, height*0.189)
    elif (width*0.650 < mouseX < width*0.940) and (height*0.401 < mouseY < height*0.599):
        image(images['start_img'], width*0.665, height*0.163, width*0.245, height*0.181)
        image(images['settings_img'], width*0.640, height*0.391, width*0.310, height*0.218)
        image(images['exit_img'], width*0.684, height*0.645, width*0.208, height*0.189)
        refresh(2, images)
    elif (width*0.684 < mouseX < width*0.892) and (height*0.645 < mouseY < height*0.834):
        image(images['start_img'], width*0.665, height*0.163, width*0.245, height*0.181)
        image(images['settings_img'], width*0.650, height*0.401, width*0.290, height*0.198)
        image(images['exit_img'], width*0.674, height*0.635, width*0.228, height*0.209)
        refresh(3, images)
    else:
        image(images['start_img'], width*0.665, height*0.163, width*0.245, height*0.181)
        image(images['settings_img'], width*0.650, height*0.401, width*0.290, height*0.198)
